...
<body>
  ...
  <iframe src="https://sites.google.com" name="frame1" class="hidden" border="0" frameborder="0"></iframe>
          ...
          <div class="calculator clearfix">
            <div class="calc-1">
              ...
              <select class="form-control" id="investment">
                ...
                <?php foreach($investment_array as $key => $value): ?>
                  <option value="<?php echo $value; ?>" <?php if($value == '250') { echo ' selected="selected"'; } ?>><?php echo number_format($value, 0, ',', '.'); ?>€</option>
                <?php endforeach; ?>
            ...
            <div class="calc-1">
              ...
              <select class="form-control" id="gain">
                ...
                <?php foreach($gain_array as $key => $value): ?>
                  <option value="<?php echo $value; ?>" <?php if($value == '5') { echo ' selected="selected"'; } ?>><?php echo number_format($value, 0, ',', '.'); ?>%</option>
                <?php endforeach; ?>
            ...
            <div class="calc-1">
              ...
              <select class="form-control" id="leverage">
                ...
                <?php foreach($leverage_array as $key => $value): ?>
                  <option value="<?php echo $value; ?>" <?php if($value == '50') { echo ' selected="selected"'; } ?>>1:<?php echo number_format($value, 0, ',', '.'); ?></option>
                <?php endforeach; ?>
